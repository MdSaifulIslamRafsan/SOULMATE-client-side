...
const ViewBoidata = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>SOULMATE || View Boidata</title>
      </Helmet>
        ...
        <div className="">
          ...
          <div className="p-8 w-full">
            <div className="grid lg:grid-cols-2 md:gap-4">
              <div>
                <h1 className="block mt-1 text-xl leading-tight font-bold text-black">
                  {biodata?.name}
                </h1>
                ...
                <p className="mt-2 text-gray-500">
                  <span className="font-bold">Height:</span> {biodata?.height}
                </p>
                <p className="mt-2 text-gray-500">
                  <span className="font-bold">Weight:</span> {biodata?.weight}
                </p>
                <p className="mt-2 text-gray-500">
                ...
                <p className="mt-2 text-gray-500">
                  <span className="font-bold">Race:</span> {biodata?.race}
                </p>
                <p className="mt-2 text-gray-500">
                  <span className="font-bold">{`Father's`} Name:</span>{" "}
                  {biodata?.fathers_name}
                </p>
                <p className="mt-2 text-gray-500">
                  <span className="font-bold">{`Mother's`} Name:</span>{" "}
                  {biodata?.mothers_name}
                </p>
              </div>
              <div>
                <p className="mt-2 text-gray-500">
                ...
                <p className="mt-2 text-gray-500">
                  ...
                  {biodata?.present_division_name}
                </p>
                <p className="mt-2 text-gray-500">
                  <span className="font-bold">Expected Partner Age:</span>{" "}
                  {biodata?.expected_partner_age}
                </p>
                <p className="mt-2 text-gray-500">
                ...
                <p className="mt-2 mb-5 text-gray-500">
                  ...
                  {biodata?.mobile_number}
                </p>
                {!(biodata?.role === "premium") && (
                  <AwesomeButton onPress={handleBoidataPremium} type="primary">
