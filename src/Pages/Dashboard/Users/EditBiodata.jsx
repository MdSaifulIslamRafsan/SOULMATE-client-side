...
const EditBiodata = () => {
  ...
  const onSubmit = (data) => {
    ...
    axiosSecure.put(`/Boidata/${userBoidata?._id}`, boidatainfo).then((res) => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>SOULMATE || Edit BioData</title>
      </Helmet>
      <div className=" bg-white border-2 shadow-md rounded-md px-8 pt-6 pb-8 mb-4">
        <h1 className="text-2xl font-bold mb-4">Biodata Form</h1>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid lg:gap-10 grid-cols-1 lg:grid-cols-2">
            <div className="mb-4">
              <label
          ...
          <div className="mb-4 mt-8 text-center">
            <AwesomeButton size="large" className="!z-0" type="primary">
              Save
            </AwesomeButton>
          </div>
        </form>
