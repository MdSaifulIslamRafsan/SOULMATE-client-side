...
const BioDatas = () => {
  ...
  const isExistPaginationData = paginationData?.filter(
    (data) => data.biodata_id
  );
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>SOULMATE || Biodatas</title>
      </Helmet>

      <section className="max-w-[1440px]  lg:w-10/12 w-11/12 mx-auto my-20 flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-3/4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">{displayUsers}</div>
          <ReactPaginate
            ...
            pageLinkClassName={"rounded-md px-3 py-1"}
            activeClassName={
