  ...
  return (
    <section className="mt-20 max-w-[1440px]  lg:w-10/12 w-11/12 mx-auto">
      <div className="lg:w-2/3 space-y-3 w-full mx-auto text-center">
        <h1 className="text-xl lg:text-4xl font-bold">Success Stories</h1>
        <p className="">
          Celebrate the beautiful journeys of our members who found love and
          happiness on our platform. Read their inspiring stories and see how
          our website has brought hearts together.
        </p>
      </div>
